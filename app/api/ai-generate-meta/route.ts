...
Пиши деловым, но дружелюбным тоном.`,
  ...
  navigation: `Создай навигационный текст для блока "Навигация" урока.

Содержание должно:
- Кратко перечислить основные разделы урока
- Описать, что ученик найдёт в каждом разделе (1-2 предложения)
- Помочь сориентироваться в структуре
- Быть кратким и чётким (маркированный список)
...
Пиши от лица автора курса.`,

  conclusion: `Создай завершающий текст для блока "Интеграция и завершение" урока.

Содержание должно:
- Подвести итоги: что ученик узнал в этом уроке
- Выделить ключевые выводы (3-5 пунктов)
- Дать рекомендации по применению знаний на практике
- Мотивировать на дальнейшее обучение
- Указать следующие шаги

Формат:
Краткое резюме урока, затем:
✓ Ключевой вывод 1
✓ Ключевой вывод 2
...

Что дальше: краткая рекомендация

Пиши воодушевляюще и конструктивно, от лица автора курса.`,
}
