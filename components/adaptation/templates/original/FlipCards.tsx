  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-full h-full bg-[#E8F4FA] border-2 border-[#659AB8] rounded-lg p-6 flex items-center justify-center">
        ...
        >
          <div className="w-full h-full bg-[#659AB8] rounded-lg p-6 flex items-center justify-center">
