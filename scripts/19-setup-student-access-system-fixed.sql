-- Setup complete student access system (FIXED VERSION)
...
-- 10. Create comprehensive RLS policies for students table (FIXED TYPES)
...
-- 11. Create comprehensive RLS policies for student_course_access table (FIXED TYPES)
